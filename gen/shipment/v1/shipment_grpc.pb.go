...
const (
	...
	ShipmentService_AddStatusEvent_FullMethodName     = "/shipment.v1.ShipmentService/AddStatusEvent"
...
type ShipmentServiceClient interface {
	...
	AddStatusEvent(ctx context.Context, in *AddStatusEventRequest, opts ...grpc.CallOption) (*ShipmentEvent, error)
...
func (c *shipmentServiceClient) AddStatusEvent(ctx context.Context, in *AddStatusEventRequest, opts ...grpc.CallOption) (*ShipmentEvent, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ShipmentEvent)
...
type ShipmentServiceServer interface {
	...
	AddStatusEvent(context.Context, *AddStatusEventRequest) (*ShipmentEvent, error)
...
func (UnimplementedShipmentServiceServer) AddStatusEvent(context.Context, *AddStatusEventRequest) (*ShipmentEvent, error) {
